*** Settings ***
Documentation      = Exemplo de suite de testes com diversos tipos de variaveis suportadas =
...                ---
...                _cmd_: ``robot -L trace -d ./results conceitos/2_builtin/2_1_variaveis.robot``
