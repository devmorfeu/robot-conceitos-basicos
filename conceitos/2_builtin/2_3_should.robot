*** Settings ***
Documentation      = Exemplo de suite de testes com should =
...                ---
...                _cmd_: ``robot -L trace -d ./results conceitos/2_builtin/2_3_should.robot``
...
Teste 5 - Should Booleano
    Should Be True           1   #Ou True
    Should Not Be True       0   #Ou False
